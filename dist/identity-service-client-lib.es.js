...
var p = "identity_service_pkce_verifier", m = "identity_service_state", h = "identity_service_required_actions";
function g(e) {
...
function C() {
	let e = localStorage.getItem(h) || "null";
...
function O(e, t) {
	if (typeof e != "string") throw new T("Invalid token specified: must be a string");
	t ||= {};
	let n = t.header === !0 ? 0 : 1, r = e.split(".")[n];
	if (typeof r != "string") throw new T(`Invalid token specified: missing part #${n + 1}`);
	let i;
	try {
		i = D(r);
	} catch (e) {
		throw new T(`Invalid token specified: invalid base64 for part #${n + 1} (${e.message})`);
	}
	try {
		return JSON.parse(i);
	} catch (e) {
		throw new T(`Invalid token specified: invalid json for part #${n + 1} (${e.message})`);
	}
}
//#endregion
...
var A = "netapp_identity_channel", j = class {
	channel = new BroadcastChannel(A);
	publish(e) {
	...
	setAccessToken(e) {
		...
		this.tokenDecoded = k(e), this.scheduleRefresh(this.tokenDecoded.exp * 1e3);
	}
	scheduleRefresh(e) {
		this.clearRefreshTimer();
	...
	async executeRefresh() {
		...
		let t = await e.json();
		return this.setAccessToken(t.accessToken), this.requiredActions = C() || M, !0;
	}
	redirect() {
	...
	async handleCallback() {
		...
		if (!n || !r) return "check";
		if (r !== b()) throw Error("Invalid state");
		let i = _();
		...
		let o = await a.json();
		this.setAccessToken(o.accessToken), v(), x(), globalThis.history.replaceState({}, document.title, globalThis.location.pathname);
	...
	async updateSpecificFields(e, t, n) {
		...
		return w(), this.requiredActions = M, i;
	}
}, P = /^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$/i, F = ({ email: e, password: t, onSubmit: n }) => {
	let [o, l] = a({
		mail: "",
		pass: "",
		cpass: ""
...
function B(e) {
	...
	return t.interceptors.request.use(async (e) => await l(e, z)), t.interceptors.response.use((e) => e, async (e) => t(await u(e, z))), t;
}
var V = t({}), H = () => n(V), U = (t) => {
	let { appName: n, options: o, global: l, children: u } = t, [d, f] = a(!0), [p, m] = a(!1), [h, g] = a(!1), [_, v] = a(!1), y = async () => {
		try {
			if (f(!0), h) return;
			g(!0), z = new N(o);
			let e = await z.handleCallback();
			if (e === "error") {
				v(!0);
				return;
			}
			e === "check" && await z.restoreSession(), m(z.isAuthenticated());
		} finally {
			if (h) return;
			g(!1), f(!1);
		}
		...
		try {
			...
			return await z?.updateSpecificFields(e.emailStr, e.passwordStr), !0;
		} catch (e) {
	...
	let x = i(() => ({
		login: () => z.login(),
		logout: () => z.logout(),
		updateUserProperties: (e, t, n) => z.updateSpecificFields(e, t, n),
		tokenDecoded: z?.tokenDecoded
	}), [
		z,
		p,
		d
	...
	return /* @__PURE__ */ s(V.Provider, {
		value: x,
		children: z ? /* @__PURE__ */ s(e, { children: d ? /* @__PURE__ */ s(R, {
			name: n,
			children: /* @__PURE__ */ s("img", {
				src: I,
				alt: "loader"
			})
		}) : /* @__PURE__ */ s(e, { children: p ? /* @__PURE__ */ s(e, { children: S?.email || S?.password ? /* @__PURE__ */ s(R, {
			name: n,
			children: /* @__PURE__ */ s(F, {
				...S,
				onSubmit: b
			})
		}) : /* @__PURE__ */ s(e, { children: u }) }) : /* @__PURE__ */ s(e, { children: _ ? /* @__PURE__ */ s(R, {
			name: n,
			children: /* @__PURE__ */ s("p", {
				className: "sso__paragraph sso__paragraph--error",
				children: "Cliente inválido"
			})
		}) : /* @__PURE__ */ s(e, { children: l ? /* @__PURE__ */ c(R, {
			name: n,
		...
		}) : /* @__PURE__ */ s(e, { children: u }) }) }) }) }) : /* @__PURE__ */ s(R, {
			name: n,
			children: /* @__PURE__ */ s("p", {
				className: "sso__paragraph sso__paragraph--error",
...
//#endregion
export { U as IdentityServiceAuthenticationProvider, W as InternalSystemAccessError, B as createIdentityServiceAxiosInstance, H as useIdentityServiceAuthentication };
