...
function V(e) {
	...
	return t.interceptors.request.use(async (e) => await l(e, B)), t.interceptors.response.use((e) => e, async (e) => t(await u(e, B))), t;
}
var H = t({}), U = () => n(H), W = (t) => {
